...
class LabExecutor:
    ...
    def run(self, script_path: str, timeout: int = DEFAULT_TIMEOUT,
            cwd: Optional[str] = None,
            env_extras: Optional[Dict[str, str]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            execution = {
                ...
                "duration_s": timeout, "script": script_path,
                "result_file": None, "result_data": None,
                "timestamp": time.time(),
            }
            ...
            execution = {
                "success": False, "exit_code": -1,
                "stdout": "", "stderr": str(e),
                "duration_s": time.time() - t0, "script": script_path,
                "result_file": None, "result_data": None,
                "timestamp": time.time(),
            }
