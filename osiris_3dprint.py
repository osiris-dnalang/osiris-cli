...
class PrintablesDownloader:
    ...
    API_URL = "https://api.printables.com/v3"
...
class PrintablesCentauriWorkflow:
    ...
    def parse_printables_url(self, url: str) -> Dict:
        ...
        # Model page URL: https://www.printables.com/model/12345-model-name
        ...
        # File download URL: https://www.printables.com/model/12345-model-name/files/67890
...
def main():
    ...
    parser.add_argument(
        "url",
        help="Printables.com model URL (e.g., https://www.printables.com/model/1349594-handle-for-elegoo-centauri-carbon-scraper-blade)"
    )
    parser.add_argument(
        "-o", "--output",
